            ...
            {items.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-4">
                  {/* Item Image */}
                  <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-purple-500 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between text-xl font-bold text-gray-900">
                    ...
                    <span className="text-blue-600">
                      ${(getTotalPrice() + 2.99 + 1.50).toFixed(2)}
                    </span>
                  </div>
                </div>
              </div>
